...
!function(){var a=function(a,b){"use strict";a.extend(!0,b.defaults,{dom:"<'row'<'col-xs-6'f><'col-xs-6'l>r><'row'<'col-xs-12't>><'row'<'col-xs-6'i><'col-xs-6'p>>",renderer:"bootstrap"})};"function"==typeof define&&define.amd?define(["jquery","datatables"],a):"object"==typeof exports?a(require("jquery"),require("datatables")):jQuery&&a(jQuery,jQuery.fn.dataTable)}(window,document),function(a){a(function(){"use strict"})}(jQuery),function(a){a(function(){console.log(123123),a("#example").dataTable()})}(jQuery);