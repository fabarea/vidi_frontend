...
!function(){if("object"==typeof VidiFrontend){var a=function(a,b){"use strict";a.extend(!0,b.defaults,{dom:VidiFrontend.dataTable.dom,renderer:"bootstrap"})};"function"==typeof define&&define.amd?define(["jquery","datatables"],a):"object"==typeof exports?a(require("jquery"),require("datatables")):jQuery&&a(jQuery,jQuery.fn.dataTable)}}(window,document),function(a){function b(a){return a=decodeURIComponent(a),a=a.replace("+"," ")}function c(a){var b=/^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/,c=["source","protocol","authority","userInfo","user","password","host","port","relative","path","directory","file","query","anchor"],d=b.exec(a||""),e={};return c.forEach(function(a,b){e[a]=d[b]||""}),e}function d(a){var b,c,d,e,f,g,h=[];if("undefined"==typeof a||null===a||""===a)return h;for(0===a.indexOf("?")&&(a=a.substring(1)),c=a.toString().split(/[&;]/),b=0;b<c.length;b++)d=c[b],e=d.split("="),f=e[0],g=-1===d.indexOf("=")?null:null===e[1]?"":e[1],h.push([f,g]);return h}function e(a){this.uriParts=c(a),this.queryPairs=d(this.uriParts.query),this.hasAuthorityPrefixUserPref=null}Array.prototype.forEach||(Array.prototype.forEach=function(a,b){for(var c=0,d=this.length;d>c;++c)a.call(b||this,this[c],c,this)}),["protocol","userInfo","host","port","path","anchor"].forEach(function(a){e.prototype[a]=function(b){return"undefined"!=typeof b&&(this.uriParts[a]=b),this.uriParts[a]}}),e.prototype.hasAuthorityPrefix=function(a){return"undefined"!=typeof a&&(this.hasAuthorityPrefixUserPref=a),null===this.hasAuthorityPrefixUserPref?-1!==this.uriParts.source.indexOf("//"):this.hasAuthorityPrefixUserPref},e.prototype.query=function(a){var b,c,e="";for("undefined"!=typeof a&&(this.queryPairs=d(a)),b=0;b<this.queryPairs.length;b++)c=this.queryPairs[b],e.length>0&&(e+="&"),null===c[1]?e+=c[0]:(e+=c[0],e+="=",c[1]&&(e+=encodeURIComponent(c[1])));return e.length>0?"?"+e:e},e.prototype.getQueryParamValue=function(a){var c,d;for(d=0;d<this.queryPairs.length;d++)if(c=this.queryPairs[d],b(a)===b(c[0]))return c[1]},e.prototype.getQueryParamValues=function(a){var c,d,e=[];for(c=0;c<this.queryPairs.length;c++)d=this.queryPairs[c],b(a)===b(d[0])&&e.push(d[1]);return e},e.prototype.deleteQueryParam=function(a,c){var d,e,f,g,h=[];for(d=0;d<this.queryPairs.length;d++)e=this.queryPairs[d],f=b(e[0])===b(a),g=b(e[1])===b(c),(1===arguments.length&&!f||2===arguments.length&&!f&&!g)&&h.push(e);return this.queryPairs=h,this},e.prototype.addQueryParam=function(a,b,c){return 3===arguments.length&&-1!==c?(c=Math.min(c,this.queryPairs.length),this.queryPairs.splice(c,0,[a,b])):arguments.length>0&&this.queryPairs.push([a,b]),this},e.prototype.replaceQueryParam=function(a,c,d){var e,f,g=-1;if(3===arguments.length){for(e=0;e<this.queryPairs.length;e++)if(f=this.queryPairs[e],b(f[0])===b(a)&&decodeURIComponent(f[1])===b(d)){g=e;break}this.deleteQueryParam(a,d).addQueryParam(a,c,g)}else{for(e=0;e<this.queryPairs.length;e++)if(f=this.queryPairs[e],b(f[0])===b(a)){g=e;break}this.deleteQueryParam(a),this.addQueryParam(a,c,g)}return this},["protocol","hasAuthorityPrefix","userInfo","host","port","path","query","anchor"].forEach(function(a){var b="set"+a.charAt(0).toUpperCase()+a.slice(1);e.prototype[b]=function(b){return this[a](b),this}}),e.prototype.scheme=function(){var a="";return this.protocol()?(a+=this.protocol(),this.protocol().indexOf(":")!==this.protocol().length-1&&(a+=":"),a+="//"):this.hasAuthorityPrefix()&&this.host()&&(a+="//"),a},e.prototype.origin=function(){var a=this.scheme();return this.userInfo()&&this.host()&&(a+=this.userInfo(),this.userInfo().indexOf("@")!==this.userInfo().length-1&&(a+="@")),this.host()&&(a+=this.host(),this.port()&&(a+=":"+this.port())),a},e.prototype.toString=function(){var a=this.origin();return this.path()?a+=this.path():this.host()&&(this.query().toString()||this.anchor())&&(a+="/"),this.query().toString()&&(0!==this.query().toString().indexOf("?")&&(a+="?"),a+=this.query().toString()),this.anchor()&&(0!==this.anchor().indexOf("#")&&(a+="#"),a+=this.anchor()),a},e.prototype.clone=function(){return new e(this.toString())},"undefined"==typeof module?a.Uri=e:module.exports=e}(this),void 0===window.VidiFrontend&&(window.VidiFrontend={}),VidiFrontend.Grid={initialize:function(a){_.each(VidiFrontend.settings,function(b,c){var d={columns:b.columns,language:b.language,stateSave:!0,stateSaveCallback:function(a,b){VidiFrontend.Session.set("dataTables"+c,JSON.stringify(b))},stateLoadCallback:function(){var a=JSON.parse(VidiFrontend.Session.get("dataTables"+c));return a},serverData:function(b,d,e,f){b+="&dataType="+VidiFrontend.settings[c].dataType,b+="&format=json",f.jqXHR=a.ajax({dataType:"json",type:"GET",url:b,data:d,success:e,error:function(){var a="Oups! Something went wrong with the Ajax request... Investigate the problem in the Network Monitor. <br />";console.log(a)}})},serverParams:function(b){for(var d=new Uri(window.location.href),e=0;e<d.queryPairs.length;e++)for(var f=d.queryPairs[e],g=f[0],h=f[1],i=["id","L"],j=0;j<i.length;j++){var k=i[j];k===g&&b.push({name:decodeURI(g),value:h})}var l=a(this).dataTable().fnSettings().aoColumns;a.each(l,function(a,c){c.bVisible&&b.push({name:VidiFrontend.parameterPrefix+"[columns][]",value:c.columnName})});var m=VidiFrontend.settings[c];b.push({name:VidiFrontend.parameterPrefix+"[contentElement]",value:c}),a.each(b,function(a,c){"sSearch"===c.name&&(c.value=VidiFrontend.VisualSearch.convertExpression(c.value,m),b.push({name:VidiFrontend.parameterPrefix+"[searchTerm]",value:c.value}))}),a("#grid-"+c).css("opacity",.3)},processing:!0,serverSide:!0,ajaxSource:"?type=1416239670",initComplete:function(){var a=VidiFrontend.Session.get("visualSearch.query"+c);VidiFrontend.bars[c].searchBox.setQuery(a)},drawCallback:function(){a("#grid-"+c).css("opacity",1),VidiFrontend.Grid.animateRow(a,c)}};d=VidiFrontend.Grid.initializeDefaultSearch(d,c),VidiFrontend.grids[c]=a("#grid-"+c).dataTable(d)})},initializeDefaultSearch:function(a,b){var c=JSON.parse(VidiFrontend.Session.get("dataTables"+b));if(!c){var d=new Uri(window.location.href);if(d.getQueryParamValue("search")){var e=d.getQueryParamValue("search");a.oSearch={sSearch:e.replace(/'/g,'"')}}d.getQueryParamValue("query")&&VidiFrontend.Session.set("visualSearch.query"+b,d.getQueryParamValue("query"))}return a},animateRow:function(a,b){if(VidiFrontend.Session.has("lastEditedUid"+b)){var c=VidiFrontend.Session.get("lastEditedUid"+b);setTimeout(function(){a("#row-"+c).addClass("fade-in")},100),setTimeout(function(){a("#row-"+c).addClass("fade-out").removeClass("fade-in"),VidiFrontend.Session.reset("lastEditedUid"+b)},500)}}},void 0===window.VidiFrontend&&(window.VidiFrontend={}),VidiFrontend.Session={get:function(a){var b;return b=null,window.sessionStorage&&(a=this._getKey(a),b=sessionStorage.getItem(a)),b},set:function(a,b){window.sessionStorage&&(a=this._getKey(a),sessionStorage.setItem(a,b))},reset:function(a){window.sessionStorage&&(a=this._getKey(a),sessionStorage.setItem(a,null))},has:function(a){return null!==this.get(a)&&""!==this.get(a)},_getKey:function(a){return"VidiFrontend."+a}},void 0===window.VidiFrontend&&(window.VidiFrontend={}),VidiFrontend.VisualSearch={initialize:function(a){_.each(VidiFrontend.settings,function(b,c){VidiFrontend.bars[c]=VS.init({container:a(".visual-search-container-"+c),query:"",callbacks:{search:function(b,d){var e=JSON.stringify(d.facets());VidiFrontend.Session.set("visualSearch.query"+c,b),a("input[aria-controls=grid-"+c+"]").val(e).keyup().keyup()},facetMatches:function(a){var b=[],d=VidiFrontend.settings[c];_.each(d.facets,function(a){b.push(a)}),a(b)},valueMatches:function(a,b,d){if("text"!==a){var e=VidiFrontend.settings[c],f=VidiFrontend.VisualSearch.retrieveFacetName(a,e);f&&VidiFrontend.VisualSearch.suggest(f,b,d,e)}}}})})},retrieveFacetName:function(a,b){var c=a;return _.each(b.facets,function(b,d){b===a&&(c=d)}),c},suggest:function(a,b,c,d){void 0===d.suggestions[a]||c(d.suggestions[a])},convertExpression:function(a,b){var c=[];if(a){a=decodeURIComponent(a);var d=JSON.parse(a);_.each(d,function(a){_.each(a,function(a,d){var e=VidiFrontend.VisualSearch.retrieveFacetName(d,b),f=VidiFrontend.VisualSearch.retrieveValue(e,a,b),g={};g[e]=f,c.push(g)})})}return JSON.stringify(c)},retrieveValue:function(a,b,c){var d=b;return _.each(c.suggestions[a],function(a,c){a===b&&(d=c)}),d}},function(a){a(function(){"object"==typeof VidiFrontend&&(VidiFrontend.Grid.initialize(a),VidiFrontend.VisualSearch.initialize(a)),a(document).on("click",".dataTable tbody tr a.link-show",function(){var b=a(this).closest("tr").attr("id").replace("row-",""),c=a(this).closest("table").attr("id").replace("grid-","");VidiFrontend.Session.set("lastEditedUid"+c,b)}),a(document).on("click",".dataTable tbody tr",function(b){var c=this.id.replace("row-",""),d=a(this).closest("table").attr("id").replace("grid-","");VidiFrontend.Session.set("lastEditedUid"+d,c);var e;b.target instanceof HTMLInputElement||b.target instanceof HTMLAnchorElement||(e=a(this).closest("tr").find(".link-show").attr("href"),window.location.href=e)})})}(jQuery);
