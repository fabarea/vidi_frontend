...
!function(a,b,c){var d=function(a,c){"use strict";a.extend(!0,c.defaults,{dom:"<'row'<'col-sm-6'l><'col-sm-6'f>><'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",renderer:"bootstrap"}),a.extend(c.ext.classes,{sWrapper:"dataTables_wrapper form-inline dt-bootstrap",sFilterInput:"form-control input-sm",sLengthSelect:"form-control input-sm"}),c.ext.renderer.pageButton.bootstrap=function(d,e,f,g,h,i){var j,k,l,m=new c.Api(d),n=d.oClasses,o=d.oLanguage.oPaginate,p=0,q=function(b,c){var e,g,l,r,s=function(b){b.preventDefault(),a(b.currentTarget).hasClass("disabled")||m.page(b.data.action).draw(!1)};for(e=0,g=c.length;e<g;e++)if(r=c[e],a.isArray(r))q(b,r);else{switch(j="",k="",r){case"ellipsis":j="&hellip;",k="disabled";break;case"first":j=o.sFirst,k=r+(h>0?"":" disabled");break;case"previous":j=o.sPrevious,k=r+(h>0?"":" disabled");break;case"next":j=o.sNext,k=r+(h<i-1?"":" disabled");break;case"last":j=o.sLast,k=r+(h<i-1?"":" disabled");break;default:j=r+1,k=h===r?"active":""}j&&(l=a("<li>",{class:n.sPageButton+" "+k,id:0===f&&"string"==typeof r?d.sTableId+"_"+r:null}).append(a("<a>",{href:"#","aria-controls":d.sTableId,"data-dt-idx":p,tabindex:d.iTabIndex}).html(j)).appendTo(b),d.oApi._fnBindAction(l,{action:r},s),p++)}};try{l=a(b.activeElement).data("dt-idx")}catch(a){}q(a(e).empty().html('<ul class="pagination"/>').children("ul"),g),l&&a(e).find("[data-dt-idx="+l+"]").focus()},c.TableTools&&(a.extend(!0,c.TableTools.classes,{container:"DTTT btn-group",buttons:{normal:"btn btn-default",disabled:"disabled"},collection:{container:"DTTT_dropdown dropdown-menu",buttons:{normal:"",disabled:"disabled"}},print:{info:"DTTT_print_info"},select:{row:"active"}}),a.extend(!0,c.TableTools.DEFAULTS.oTags,{collection:{container:"ul",button:"li",liner:"a"}}))};"function"==typeof define&&define.amd?define(["jquery","datatables"],d):"object"==typeof exports?d(require("jquery"),require("datatables")):jQuery&&d(jQuery,jQuery.fn.dataTable)}(window,document);

!function(a,b,c){if("object"==typeof VidiFrontend){var d=function(a,b){"use strict";a.extend(!0,b.defaults,{dom:VidiFrontend.dataTable.dom,renderer:"bootstrap"})};"function"==typeof define&&define.amd?define(["jquery","datatables"],d):"object"==typeof exports?d(require("jquery"),require("datatables")):jQuery&&d(jQuery,jQuery.fn.dataTable)}}(window,document),function(a){function b(a){return a=decodeURIComponent(a),a=a.replace("+"," ")}function c(a){var b=/^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/,c=["source","protocol","authority","userInfo","user","password","host","port","relative","path","directory","file","query","anchor"],d=b.exec(a||""),e={};return c.forEach(function(a,b){e[a]=d[b]||""}),e}function d(a){var b,c,d,e,f,g,h=[];if("undefined"==typeof a||null===a||""===a)return h;for(0===a.indexOf("?")&&(a=a.substring(1)),c=a.toString().split(/[&;]/),b=0;b<c.length;b++)d=c[b],e=d.split("="),f=e[0],g=d.indexOf("=")===-1?null:null===e[1]?"":e[1],h.push([f,g]);return h}function e(a){this.uriParts=c(a),this.queryPairs=d(this.uriParts.query),this.hasAuthorityPrefixUserPref=null}Array.prototype.forEach||(Array.prototype.forEach=function(a,b){for(var c=0,d=this.length;c<d;++c)a.call(b||this,this[c],c,this)}),["protocol","userInfo","host","port","path","anchor"].forEach(function(a){e.prototype[a]=function(b){return"undefined"!=typeof b&&(this.uriParts[a]=b),this.uriParts[a]}}),e.prototype.hasAuthorityPrefix=function(a){return"undefined"!=typeof a&&(this.hasAuthorityPrefixUserPref=a),null===this.hasAuthorityPrefixUserPref?this.uriParts.source.indexOf("//")!==-1:this.hasAuthorityPrefixUserPref},e.prototype.query=function(a){var b,c,e="";for("undefined"!=typeof a&&(this.queryPairs=d(a)),b=0;b<this.queryPairs.length;b++)c=this.queryPairs[b],e.length>0&&(e+="&"),null===c[1]?e+=c[0]:(e+=c[0],e+="=",c[1]&&(e+=encodeURIComponent(c[1])));return e.length>0?"?"+e:e},e.prototype.getQueryParamValue=function(a){var c,d;for(d=0;d<this.queryPairs.length;d++)if(c=this.queryPairs[d],b(a)===b(c[0]))return c[1]},e.prototype.getQueryParamValues=function(a){var c,d,e=[];for(c=0;c<this.queryPairs.length;c++)d=this.queryPairs[c],b(a)===b(d[0])&&e.push(d[1]);return e},e.prototype.deleteQueryParam=function(a,c){var d,e,f,g,h=[];for(d=0;d<this.queryPairs.length;d++)e=this.queryPairs[d],f=b(e[0])===b(a),g=b(e[1])===b(c),(1===arguments.length&&!f||2===arguments.length&&!f&&!g)&&h.push(e);return this.queryPairs=h,this},e.prototype.addQueryParam=function(a,b,c){return 3===arguments.length&&c!==-1?(c=Math.min(c,this.queryPairs.length),this.queryPairs.splice(c,0,[a,b])):arguments.length>0&&this.queryPairs.push([a,b]),this},e.prototype.replaceQueryParam=function(a,c,d){var e,f,g=-1;if(3===arguments.length){for(e=0;e<this.queryPairs.length;e++)if(f=this.queryPairs[e],b(f[0])===b(a)&&decodeURIComponent(f[1])===b(d)){g=e;break}this.deleteQueryParam(a,d).addQueryParam(a,c,g)}else{for(e=0;e<this.queryPairs.length;e++)if(f=this.queryPairs[e],b(f[0])===b(a)){g=e;break}this.deleteQueryParam(a),this.addQueryParam(a,c,g)}return this},["protocol","hasAuthorityPrefix","userInfo","host","port","path","query","anchor"].forEach(function(a){var b="set"+a.charAt(0).toUpperCase()+a.slice(1);e.prototype[b]=function(b){return this[a](b),this}}),e.prototype.scheme=function(){var a="";return this.protocol()?(a+=this.protocol(),this.protocol().indexOf(":")!==this.protocol().length-1&&(a+=":"),a+="//"):this.hasAuthorityPrefix()&&this.host()&&(a+="//"),a},e.prototype.origin=function(){var a=this.scheme();return this.userInfo()&&this.host()&&(a+=this.userInfo(),this.userInfo().indexOf("@")!==this.userInfo().length-1&&(a+="@")),this.host()&&(a+=this.host(),this.port()&&(a+=":"+this.port())),a},e.prototype.toString=function(){var a=this.origin();return this.path()?a+=this.path():this.host()&&(this.query().toString()||this.anchor())&&(a+="/"),this.query().toString()&&(0!==this.query().toString().indexOf("?")&&(a+="?"),a+=this.query().toString()),this.anchor()&&(0!==this.anchor().indexOf("#")&&(a+="#"),a+=this.anchor()),a},e.prototype.clone=function(){return new e(this.toString())},"undefined"==typeof module?a.Uri=e:module.exports=e}(this),void 0===window.VidiFrontend&&(window.VidiFrontend={}),VidiFrontend.Grid={storage:{},initialize:function(){var a=this.getJQuery();_.each(VidiFrontend.settings,function(b,c){_.each(b.suggestions,function(a,c){var d=[],e={};_.each(a,function(a){if("object"==typeof a){var b=Object.keys(a),c=b[0],f=a[c];d.push(f),e[c]=f}else d.push(a)}),b.search.labels[c]=d,b.search.values[c]=e});var d={columns:b.columns,language:b.language,lengthMenu:b.lengthMenu,stateSave:!0,sorting:[],stateSaveCallback:function(a,b){VidiFrontend.Session.set("dataTables"+c,JSON.stringify(b))},stateLoadCallback:function(a){var b=JSON.parse(VidiFrontend.Session.get("dataTables"+c));return b},processing:b.loadContentByAjax,serverSide:b.loadContentByAjax,createdRow:function(b,c,d){c.DT_uri&&a(b).attr("data-uri",c.DT_uri)},initComplete:function(a,b){var d=VidiFrontend.Session.get("visualSearch.query"+c);VidiFrontend.bars[c]&&VidiFrontend.bars[c].searchBox.setQuery(d)},drawCallback:function(b){if(a("#grid-"+c).css("opacity",1),VidiFrontend.Grid.animateRow(a,c),"object"==typeof VidiFrontend.grids[c]){var d=VidiFrontend.settings[c].language,e=d["rows.all"].replace("%s",VidiFrontend.grids[c].fnSettings().fnRecordsTotal());a(".mass-action-label-"+c).html('<span class="caret"></span> '+e)}}};if(b.loadContentByAjax){var e=new Uri(window.location.pathname).deleteQueryParam("cHash").addQueryParam("type","1416239670");d.ajax={url:b.loadContentByAjax?e:"",data:function(b){for(var d=new Uri(window.location.href).deleteQueryParam("cHash"),e=0;e<d.queryPairs.length;e++){var f=d.queryPairs[e],g=f[0],h=f[1],i=["id","L"];(g.indexOf("tx_vidifrontend_pi1[matches]")>-1||a.inArray(g,i)>-1)&&(b[decodeURI(g)]=h)}b.dataType=VidiFrontend.settings[c].dataType,b.format="json";var j=VidiFrontend.settings[c];b[VidiFrontend.parameterPrefix+"[contentData]"]=j.contentElementIdentifier,VidiFrontend.Grid.storage[c]="",b.search.value&&(b.search.value=VidiFrontend.VisualSearch.convertExpression(b.search.value,j),b[VidiFrontend.parameterPrefix+"[searchTerm]"]=b.search.value,VidiFrontend.Grid.storage[c]=b.search.value),a("#grid-"+c).css("opacity",.3),delete b.columns,delete b.draw},error:function(){var a="Oups! Something went wrong with the Ajax request... Investigate the problem in the Network Monitor.";console.log(a)}}}d=VidiFrontend.Grid.initializeDefaultSearch(d,c),VidiFrontend.grids[c]=a("#grid-"+c).dataTable(d);var f=VidiFrontend.settings[c].language,g=f["rows.all"].replace("%s",VidiFrontend.grids[c].fnSettings().fnRecordsTotal());a(".mass-action-label-"+c).html('<span class="caret"></span> '+g)})},initializeDefaultSearch:function(a,b){var c=JSON.parse(VidiFrontend.Session.get("dataTables"+b));if(!c){var d=new Uri(window.location.href);if(d.getQueryParamValue("search")){var e=d.getQueryParamValue("search");a.oSearch={sSearch:e.replace(/'/g,'"')}}d.getQueryParamValue("query")&&VidiFrontend.Session.set("visualSearch.query"+b,d.getQueryParamValue("query"))}return a},animateRow:function(a,b){if(VidiFrontend.Session.has("lastEditedUid"+b)){var c=VidiFrontend.Session.get("lastEditedUid"+b);setTimeout(function(){a("#row-"+c).addClass("fade-in")},100),setTimeout(function(){a("#row-"+c).addClass("fade-out").removeClass("fade-in"),VidiFrontend.Session.reset("lastEditedUid"+b)},500)}},attachHandler:function(){var a=this.getJQuery();_.each(VidiFrontend.settings,function(b,c){a(document).on("click","#grid-"+b.gridIdentifier+" .btn-export",function(b){b.preventDefault();var d=new Uri(document.location.href),e=new Uri(a(this).attr("href")).setProtocol(d.protocol()).setHost(d.host()).setPath(d.path());if(VidiFrontend.Grid.hasSelectedRows(c)){var f=VidiFrontend.Grid.getSelectedIdentifiers(c);e.addQueryParam(encodeURI(VidiFrontend.parameterPrefix+"[matches][uid]"),f.join(","))}"string"==typeof VidiFrontend.Grid.storage[c]&&e.addQueryParam("search",VidiFrontend.Grid.storage[c]),window.location=e.toString()}),a(document).on("click","#grid-"+b.gridIdentifier+" tbody .checkbox-row",function(){var b,d=VidiFrontend.settings[c].language;VidiFrontend.Grid.hasSelectedRows(c)?(b=d["rows.selected"],b=b.replace("%s",VidiFrontend.Grid.getNumberOfSelectedRows(c))):(b=d["rows.all"],b=b.replace("%s",VidiFrontend.grids[c].fnSettings().fnRecordsTotal())),a(".mass-action-label-"+c).html('<span class="caret"></span> '+b)}),a("#grid-"+b.gridIdentifier+" .checkbox-row-top").click(function(){var b=a(this).closest("table"),c=a(b).find(".checkbox-row");a(this).is(":checked")?c.filter(":not(:checked)").click():c.filter(":checked").click()}),b.hasClickOnRow&&(a(document).on("click","#grid-"+b.gridIdentifier+" tbody tr a.link-show",function(b){var c=a(this).closest("tr").attr("id").replace("row-",""),d=a(this).closest("table").attr("id").replace("grid-","");VidiFrontend.Session.set("lastEditedUid"+d,c)}),a(document).on("click","#grid-"+b.gridIdentifier+" tbody tr",function(b){var c=this.id.replace("row-",""),d=a(this).closest("table").attr("id").replace("grid-","");VidiFrontend.Session.set("lastEditedUid"+d,c);var e;b.target instanceof HTMLInputElement||b.target instanceof HTMLAnchorElement||a(this).data("uri")&&(e=a(this).closest("tr").data("uri"),window.location.href=e)}))})},getSelectedIdentifiers:function(a){var b=this.getJQuery(),c=[];return b("#grid-"+a).find(".checkbox-row").filter(":checked").each(function(a){var d=b(this).data("uid");c.push(d)}),c},getNumberOfRows:function(a){var b=this.getJQuery(),c=b("#grid-"+a).find("tbody tr").length;return c},getNumberOfSelectedRows:function(a){return VidiFrontend.Grid.getSelectedIdentifiers(a).length},hasSelectedRows:function(a){return VidiFrontend.Grid.getSelectedIdentifiers(a).length>0},getJQuery:function(){return VidiFrontend.Grid.jQuery},setJQuery:function(a){VidiFrontend.Grid.jQuery=a}},void 0===window.VidiFrontend&&(window.VidiFrontend={}),VidiFrontend.Session={get:function(a){var b;return b=null,window.sessionStorage&&(a=this._getKey(a),b=sessionStorage.getItem(a)),b},set:function(a,b){window.sessionStorage&&(a=this._getKey(a),sessionStorage.setItem(a,b))},reset:function(a){window.sessionStorage&&(a=this._getKey(a),sessionStorage.setItem(a,null))},has:function(a){return null!==this.get(a)&&""!==this.get(a)},_getKey:function(a){return"VidiFrontend."+a}},void 0===window.VidiFrontend&&(window.VidiFrontend={}),VidiFrontend.VisualSearch={initialize:function(a){_.each(VidiFrontend.settings,function(b,c){VidiFrontend.bars[c]=VS.init({container:a(".visual-search-container-"+c),query:"",showFacets:!0,callbacks:{search:function(b,d){var e=JSON.stringify(d.facets());VidiFrontend.Session.set("visualSearch.query"+c,b),a("input[aria-controls=grid-"+c+"]").val(e).keyup().keyup()},facetMatches:function(a){var b=[],d=VidiFrontend.settings[c];_.each(d.facets,function(a){b.push(a)}),a(b,{preserveOrder:!0})},valueMatches:function(a,b,d){if("text"!==a){var e=VidiFrontend.settings[c],f=VidiFrontend.VisualSearch.retrieveFacetName(a,e);f&&VidiFrontend.VisualSearch.suggest(f,b,d,e)}}}})})},retrieveFacetName:function(a,b){var c=a;return _.each(b.facets,function(b,d){b===a&&(c=d)}),c},suggest:function(a,b,c,d){c(d.search.labels[a])},convertExpression:function(a,b){var c=[];if(a){a=decodeURIComponent(a);var d=[{text:a}];try{d=JSON.parse(a)}catch(a){}_.each(d,function(a){_.each(a,function(a,d){var e=VidiFrontend.VisualSearch.retrieveFacetName(d,b),f=VidiFrontend.VisualSearch.retrieveValue(e,a,b),g={};g[e]=f,c.push(g)})})}return JSON.stringify(c)},retrieveValue:function(a,b,c){var d=b;return _.each(c.search.values[a],function(a,c){a===b&&(d=c)}),d}},function(a){a(function(){"object"==typeof VidiFrontend&&(VidiFrontend.Grid.setJQuery(a),VidiFrontend.Grid.initialize(),VidiFrontend.VisualSearch.initialize(a),VidiFrontend.Grid.attachHandler())})}(jQuery);
